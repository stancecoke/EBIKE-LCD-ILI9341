...
#define FONT5	ICON48x70
#define BIGFONT Arial48x70
...
extern const uint8_t Arial_11x18_Table[];
extern const uint8_t Arial48x70[];
extern const uint8_t ICON48x70[];
extern const uint8_t Arial_Unicode_MS48x50[];
#endif // __FONTS_H__
